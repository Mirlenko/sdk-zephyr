...
/** Remote channel sounding capabilities for LE connections supporting CS V2 */
struct bt_conn_le_cs_capabilities_v2 {
	/** Number of CS configurations */
	uint8_t num_config_supported;
	/** Maximum number of consecutive CS procedures.
	 *
...
struct bt_conn_cb {
	...
	/** @brief LE CS Read Remote Supported Capabilities V2 Complete event.
	 *
	 *  This callback notifies the application that a Channel Sounding
	 *  Capabilities Exchange procedure has completed.
	 *
	 ...
	 *  @param remote_cs_capabilities Pointer to CS Capabilities on success or NULL otherwise.
	 */
	 void (*le_cs_read_remote_capabilities_complete_v2)(struct bt_conn *conn,
		uint8_t status,
